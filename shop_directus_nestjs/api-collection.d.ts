...
export interface paths {
  ...
  "/items/tag": {
    /**
     * List Items
     * @description List the tag items.
     */
    get: operations["readItemsTag"];
    /**
     * Create an Item
     * @description Create a new tag item.
     */
    post: operations["createItemsTag"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing tag items.
     */
    delete: operations["deleteItemsTag"];
    /**
     * Update Multiple Items
     * @description Update multiple tag items at the same time.
     */
    patch: operations["updateItemsTag"];
  };
  "/items/tag/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single tag item by unique identifier.
     */
    get: operations["readSingleItemsTag"];
    /**
     * Delete an Item
     * @description Delete an existing tag item.
     */
    delete: operations["deleteSingleItemsTag"];
    /**
     * Update an Item
     * @description Update an existing tag item.
     */
    patch: operations["updateSingleItemsTag"];
  };
  "/items/product_tag": {
    /**
     * List Items
     * @description List the product_tag items.
     */
    get: operations["readItemsProductTag"];
    /**
     * Create an Item
     * @description Create a new product_tag item.
     */
    post: operations["createItemsProductTag"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing product_tag items.
     */
    delete: operations["deleteItemsProductTag"];
    /**
     * Update Multiple Items
     * @description Update multiple product_tag items at the same time.
     */
    patch: operations["updateItemsProductTag"];
  };
  "/items/product_tag/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single product_tag item by unique identifier.
     */
    get: operations["readSingleItemsProductTag"];
    /**
     * Delete an Item
     * @description Delete an existing product_tag item.
     */
    delete: operations["deleteSingleItemsProductTag"];
    /**
     * Update an Item
     * @description Update an existing product_tag item.
     */
    patch: operations["updateSingleItemsProductTag"];
  };
  "/items/product": {
    /**
     * List Items
...
export interface components {
  schemas: {
    ...
    ItemsProductTag: {
      ...
      tag_id?: string | components["schemas"]["ItemsTag"] | null;
    };
    ItemsProduct: {
      /** Format: uuid */
      id: string;
      ...
      video?: string | components["schemas"]["Files"] | null;
      tags?: ((number | components["schemas"]["ItemsProductTag"])[]) | null;
    };
    ItemsCategory: {
      /** Format: uuid */
      id: string;
...
export interface operations {
  ...
  readItemsTag: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsTag"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsTag: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsTag"][] | components["schemas"]["ItemsTag"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsTag: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsTag"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsProductTag: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsProductTag"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsProductTag: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsProductTag"][] | components["schemas"]["ItemsProductTag"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  updateSingleItemsProductTag: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsProductTag"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type ApiCollections = {
  tag: components["schemas"]["ItemsTag"][];
  product_tag: components["schemas"]["ItemsProductTag"][];
